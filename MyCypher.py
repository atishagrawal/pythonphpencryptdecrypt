...
class MyCypher:
    ...
    def encrypt(self, raw):
        cipher = AES.new(self.getKEY().encode(), self.method, self.getIV().encode(), segment_size=128)
        return base64.b64encode(cipher.encrypt(self.pad(raw).encode()))
    ...
    def decrypt(self, encrypted):
        ...
        return cipher.decrypt(encrypted).rstrip(self.padwith.encode())
